...
|---------|---------|---------|-------|-------|
| **npm** | `@gopdfjs/runners` | isomorphic | **Partial** | `protectPdf()` — one pkg, Node + browser |
| **CLI** | `gopdf-cli protect` | node | **Planned** | thin wrapper over npm above |
| **Rust / WASM** | — | — | Web Crypto (Node + browser) | per RFC + [0057](../0057-rust-wasm-worker-architecture.md) |
