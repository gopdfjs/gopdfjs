...
description: "This guide details how to correctly configure TypeScript in your project to use GoPDF.js."
---

This guide details how to correctly configure TypeScript in your project to use GoPDF.js.
...
- **`jsxImportSource: "@wsxjs/wsx-core"`** - Specify JSX runtime source as GoPDF.js
...
**Configuration Notes**:
- **`types: ["@wsxjs/wsx-core"]`** - Explicitly reference GoPDF.js type definitions
...
### 6. External Project Integration with GoPDF.js
...
- [Quick Start Guide](./getting-started.md) - Get started with GoPDF.js in 5 minutes
...
**Need help?** If you encounter configuration issues, please check the [Common Issues](#common-issues) section or ask questions on [GitHub Issues](https://github.com/systembug/gopdf/issues).
