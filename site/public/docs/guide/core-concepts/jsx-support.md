---
title: GoPDF.js JSX Support Documentation
order: 3
category: guide/core-concepts
description: "GoPDF.js provides complete JSX support without relying on React or other frameworks. Through framework-level configuration, any project using WSX can get out-of-the-box JSX experience."
---

## Overview

GoPDF.js provides complete JSX support without relying on React or other frameworks. Through framework-level configuration, any project using WSX can get out-of-the-box JSX experience.
...
GoPDF.js uses pure native JSX factory functions:
...
GoPDF.js provides a dedicated Vite plugin:
...
GoPDF.js creates a dedicated JSX entry point:
...
GoPDF.js's JSX support provides:
