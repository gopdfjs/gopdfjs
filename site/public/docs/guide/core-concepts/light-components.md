...
description: "LightComponent is a lightweight custom element base class provided by GoPDF.js, designed for scenarios that require integration with third-party libraries or use Light DOM"
---

## Overview

`LightComponent` is a lightweight custom element base class provided by GoPDF.js, designed for scenarios that require integration with third-party libraries or use Light DOM. It directly inherits from `HTMLElement`, does not use Shadow DOM, and provides complete reactive state management and JSX support.
...
GoPDF.js provides intelligent CSS auto-injection. If a component file `MyComponent.wsx` has a corresponding `MyComponent.css` file, the Babel plugin will automatically:
...
A: GoPDF.js provides intelligent CSS auto-injection. If a component file `MyComponent.wsx` has a corresponding `MyComponent.css` file, the Babel plugin will automatically:
