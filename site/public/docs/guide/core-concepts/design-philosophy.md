---
title: GoPDF.js Design Philosophy
order: 4
category: guide/core-concepts
description: "GoPDF.js is a native-first Web Components framework dedicated to providing the closest experience to native Web development"
---

## Overview

GoPDF.js is a **native-first** Web Components framework dedicated to providing the closest experience to native Web development while maintaining the convenience of modern frameworks.

## Core Design Principles

### 1. Native-First

GoPDF.js prioritizes native Web standards and APIs over creating abstraction layers.

#### Example: class vs className

```jsx
// ✅ GoPDF.js - Uses native HTML attribute names
<div class="container">
...
GoPDF.js's design philosophy is **return to native, embrace standards**. By using native Web technologies, we gain:
