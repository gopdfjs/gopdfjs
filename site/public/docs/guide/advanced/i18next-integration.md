...
description: "@wsxjs/wsx-i18next provides i18next internationalization support for GoPDF.js components, making it easy for your application to support multiple languages"
---

`@wsxjs/wsx-i18next` provides i18next internationalization support for GoPDF.js components, making it easy for your application to support multiple languages.
...
> 
> **Reference**: GoPDF.js official site (`site/vite.config.ts`) correctly configures this plugin, so decorators work there.
